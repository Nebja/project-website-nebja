<template>
  <div class="card bg-transparent border-0 w-100 m-auto">
    <div class="card-body text-white text-shadow mw-50 m-auto">
      <h5 class="card-title">About my Work</h5>
      <p class="card-text">
        After finding my way in Berlin in 2012 , in 2017 i decided to go back to the job i loved so much back in 2005 , in Coding.
        <br>
